  ...
  return (
    <AccordionHeaderPrimitive className="flex">
      <AccordionTriggerPrimitive
        className={cn(
          "group focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 items-center justify-between gap-4 rounded-md py-4 text-left text-sm font-medium transition-all outline-none hover:underline focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50",
          className
        )}
        {...props}
      >
        ...
        {showArrow && (
          <span className="relative flex h-4 w-4 shrink-0">
            ...
            <PlusIcon
              aria-hidden
              className={cn(
                "bg-white/5 border border-white/10 rounded-full p-1 absolute inset-0 m-auto size-6 mr-1 transition-all duration-200 ease-in-out",
            ...
            <MinusIcon
              aria-hidden
              className={cn(
                " bg-white/5 border border-white/10 rounded-full p-1 absolute inset-0 m-auto size-6 mr-1 opacity-0 scale-75 transition-all duration-200 ease-in-out",
